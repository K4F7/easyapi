...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-32 overflow-hidden rounded-md border border-border bg-card p-1 text-card-foreground shadow-subtle",
      className,
    )}
    {...props}
  />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-36 overflow-hidden rounded-md border border-border bg-card p-1 text-card-foreground shadow-subtle",
        className,
      )}
      {...props}
    />
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("ml-auto text-xs tracking-normal text-muted-subtle", className)}
      {...props}
    />
  );
};
